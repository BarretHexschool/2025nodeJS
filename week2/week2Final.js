...
let g = 8;
let h = "8";
console.log(g * h == 88); //64,false
console.log(g * h == 64); //64 true
...
var l = "8";
// 請文字解釋為什麼
console.log(k * l > 21); // 因為做乘除運算時，會轉型成數值做計算。故 K*l = 24
...
if (coachIncome > 300000) {
  coachBonus += (coachIncome * 20) / 100;
} else if (coachIncome > 100000) {
  coachBonus += (coachIncome * 15) / 100;
} else {
  coachBonus += (coachIncome * 10) / 100;
}
...
const gymCoach = {
  gymData: {
    gymLocal: "高雄市",
    gymName: "高雄市健身教練聯盟",
    gymDescription: "專注於提供高品質的健身指導服務。健身房內有多位專業教練",
  },
  coachsData: [
    {
      name: "王教練",
      expertise: ["力量訓練", "減重課程"],
      class: [
        { type: "個人", charge: "2000", duration: "60", availability: true },
        { type: "團體", charge: "1500", duration: "90", availability: false },
      ],
      background:
    ...
    },
    {
      ...
      expertise: ["瑜伽", "體態雕塑"],
      class: [
        { type: "個人", charge: "1800", duration: "50", availability: false },
        { type: "團體", charge: "1200", duration: "75", availability: true },
      ],
      background:
...
let calorieBurn = 0;
calorieBurn +=
  10 * activities.cycling.burnCalories +
  30 * activities.treadmill.burnCalories +
  40 * activities.yoga.burnCalories +
  10 * activities.cycling.burnCalories;
